...
@section('content')
    ...
    <div class="wrapper">
        <div class="header header-filter" style="background-image: url({{ base_url('assets/img/bg2.jpeg')}}">
            <div class="container">
                <div class="row">
                    <div class="col-md-8 col-md-offset-2">
                        <div class="brand">
                            <h1>Servicios</h1>
                            <h3>Encuentra al mejor</h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="container tim-container">
                    ...
                    <div id="images">
                        ...
                        <div class="row">
                            <div class="col-sm-2">
                                <h4>Rounded Image</h4>
                                <img src="{{ base_url('assets/img/avatar.jpg')}}" alt="Rounded Image" class="img-rounded img-responsive">
                            </div>
                            <div class="col-sm-2 col-sm-offset-1">
                                <h4>Circle Image</h4>
                                <img src="{{ base_url('assets/img/avatar.jpg')}}" alt="Circle Image" class="img-circle img-responsive">
                            </div>
                            <div class="col-sm-2 col-sm-offset-1">
                                <h4>Rounded Raised</h4>
                                <img src="{{ base_url('assets/img/avatar.jpg')}}" alt="Raised Image" class="img-rounded img-responsive img-raised">
                            </div>

                            <div class="col-sm-2 col-sm-offset-1">
                                <h4>Circle Raised</h4>
                                <img src="{{ base_url('assets/img/avatar.jpg')}}" alt="Thumbnail Image" class="img-circle img-raised img-responsive">
                            </div>
                        </div>
                        <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <a href="examples/profile-page.html" target="_blank">
                                <img src="{{ base_url('assets/img/profile.jpg')}}" alt="Rounded Image" class="img-rounded img-raised img-responsive">
