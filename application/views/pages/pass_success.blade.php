...
@section('title', 'Contraseña correcta')
			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-10 col-md-offset-1 col-sm-8 col-sm-offset-2">
							<h2 class="text-center" style="color:white"> Listo!</h2>
							<br>
							<h3 class="text-center" style="color:white">Un correo ha sido enviado con tu nueva contraseña</h3>
					</div>
